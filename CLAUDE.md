...
| Key | Value |
|-----|-------|
| **Local path** | `~/devs/github/all-shanti-unicef-pitch` |
| **Remote** | `https://github.com/gtcuco-q-liri/all-shanti-unicef-pitch.git` |
| **GitHub account** | `gtcuco-q-liri` |
